...
class Waypoint(LatLon):  # send the parent class as a parameter when creating the child class
    ...
    def __str__(self):
        return (f"\033[36m=========={self.name}========== \n\033[37mLatitude: \033[31m{self.lat} \n\033[37mLongitude: \033[31m{self.lon}")
...
class Geocache(Waypoint):
    ...
    def __str__(self):
        return (f"\033[36m=========={self.name}========== \n\033[37mDifficulty: \033[31m{self.difficulty} \n\033[37mSize: \033[31m{self.size} \n\033[37mLatitude: \033[31m{self.lat} \n\033[37mLongitude: \033[31m{self.lon}")
